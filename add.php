<?php  
    ...
    if(isset($_POST['bsm'])){
        ...
        $sql="INSERT INTO sp VALUES('$id_sp','$ten_sp','$anh_sp','$gia_sp','$so_luong_sp','$mo_ta_sp','$id_loai_sp')";
            ...
            <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data">
                    <!-- <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="id_sp" id="id_sp">
                    </div> -->

                    <div class="form-group">
                        <label for="ten_sp">Tên sản phẩm</label>
                        <input type="text" class="form-control" name="ten_sp" id="ten_sp" >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="gia_sp" id="gia_sp" >
                    </div>

                    <div class="form-group">
                        <label for="so_luong_sp">Số lượng sản phẩm</label>
                        <input type="number" class="form-control" name="so_luong_sp" id="so_luong_sp" >
                    </div>

                    <div class="form-group">
                        <label for="mo_ta_sp">Mô tả sản phẩm</label>
                        <input type="text" class="form-control" name="mo_ta_sp" id="mo_ta_sp" >
                    </div>
                    ...
                    <button class="btn btn-dark" name="bsm">Thêm</button>
                </form>
            </div>
        </div>
    </div>
